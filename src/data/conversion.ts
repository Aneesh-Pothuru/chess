...
export const CONVERSION_DRILLS: ConversionDrill[] = [
  ...
  },
  {
    ...
    fen: '3r2k1/5ppp/8/8/8/8/5PPP/2QR2K1 w - - 0 28',
    playerColor: 'w',
    edge: 'Queen for nothing, but Black still has an active rook.',
    plan: 'Offer the rook trade (Rxd8 ideas) or force it with back-rank pressure. Every trade multiplies your advantage. Scan for mate-in-1 both ways every single move.',
  },
  {
    id: 'exchange-up',
    title: 'Exchange up, technique required',
    fen: '6k1/pp3ppp/4b3/8/8/8/PP3PPP/3R2K1 w - - 0 25',
    playerColor: 'w',
    edge: 'Rook vs bishop.',
  ...
  },
  {
    ...
    fen: '6k1/5ppp/8/8/8/8/q4PPP/1R1Q2K1 w - - 0 30',
    playerColor: 'w',
    edge: 'A whole rook, but the black queen is loose in your camp.',
    plan: 'The counterplay-killer: offer the QUEEN trade (Qd2, Qb3). With queens off, a rook up is trivial. Never move a kingside pawn while her queen is near — that is how perpetuals happen.',
  },
  {
    id: 'outside-passer',
    title: 'Two up: the outside passer',
    fen: '8/5pk1/6p1/8/1P6/5PP1/6KP/8 w - - 0 40',
    playerColor: 'w',
  ...
  },
  {
    ...
    plan: 'Finish in under six moves WITHOUT stalemate. Box, king up, mate. If your move leaves the king zero replies and no check — that was stalemate; the drill fails.',
  },
]
